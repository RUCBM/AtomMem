...
def get_custom_reward_fn(config):
    ...
    wrapped_fn = partial(raw_fn, **reward_kwargs)
...
def load_reward_manager(config, tokenizer, num_examine, **reward_kwargs):
    ...
    elif reward_manager_name == 'thread_agent':
        from verl.workers.reward_manager import ThreadAgentRewardManager

        reward_manager_cls = ThreadAgentRewardManager
    else:
...
def compute_reward(data: DataProto, reward_fn):
    ...
    try:
        ...
        score_tensor = reward_result["score_tensor"]
    ...
    return reward_tensor, score_tensor, reward_extra_infos_dict
