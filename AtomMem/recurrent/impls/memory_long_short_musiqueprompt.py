...
1) Perform reasoning for each question in your short-term memory, clearly listing the information that is currently known and the information that is missing. Your short-term memory should only change slightly at each step.

2) At each step, add the important results obtained from your reasoning and the important information from environmental feedback into long-term memory.

3) Update the query at every step to meet the current information needs.
